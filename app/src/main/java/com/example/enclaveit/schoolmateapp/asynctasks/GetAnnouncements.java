...
public class GetAnnouncements extends AsyncTask<String, Void, String>{
    ...
    private static final String MESSAGE = "Announcement";
    private static final String TAG = "Lorence";
    ...
    public GetAnnouncements(ActivityAnnoucement context){
    ...
    protected String doInBackground(String... params) {
        ...
        return message; /*Execute onPostExecute next*/
    }
    ...
    protected void onPostExecute(String result) {
        ...
        /*Convert data to JSON*/
            try {
                ...
                Log.i(MESSAGE, "JSON Result Details Length = " + jsonArrayResultDetails.length());
