...
public class AdapterAnnounceFee extends BaseAdapter {

    private List<Announcement> listItems;
    private LayoutInflater layoutInflater;
    private Context context;

    public AdapterAnnounceFee(Context context, List<Announcement> listItems){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.item_listview_fee, null);
